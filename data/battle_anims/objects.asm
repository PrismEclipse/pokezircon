...
; BATTLE_ANIM_OBJ_EMBER
	battleanimobj RELATIVE_X, $a8, BATTLE_ANIM_FRAMESET_EMBER, BATTLE_ANIM_FUNC_EMBER, PAL_BATTLE_OB_RED, BATTLE_ANIM_GFX_FIRE
...
; BATTLE_ANIM_OBJ_ICE_BEAM
	battleanimobj RELATIVE_X, $94, BATTLE_ANIM_FRAMESET_ICE_BEAM, BATTLE_ANIM_FUNC_USER_TO_TARGET, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_ICE
...
; BATTLE_ANIM_OBJ_EXPLOSION1
	battleanimobj RELATIVE_X, $88, BATTLE_ANIM_FRAMESET_EXPLOSION, BATTLE_ANIM_FUNC_NULL, PAL_BATTLE_OB_RED, BATTLE_ANIM_GFX_EXPLOSION
...
; BATTLE_ANIM_OBJ_WATER_GUN
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $7c, BATTLE_ANIM_FRAMESET_WATER_GUN_1, BATTLE_ANIM_FUNC_WATER_GUN, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_WATER
...
; BATTLE_ANIM_OBJ_MASTER_BALL_SPARKLE
	battleanimobj RELATIVE_X, $b8, BATTLE_ANIM_FRAMESET_CIRCLING_SPARKLE, BATTLE_ANIM_FUNC_RECOVER, PAL_BATTLE_OB_YELLOW, BATTLE_ANIM_GFX_SPEED
...
; BATTLE_ANIM_OBJ_THUNDER_WAVE
	battleanimobj RELATIVE_X | X_FLIP, $8e, BATTLE_ANIM_FRAMESET_THUNDER_WAVE_DISABLE, BATTLE_ANIM_FUNC_THUNDER_WAVE, PAL_BATTLE_OB_YELLOW, BATTLE_ANIM_GFX_LIGHTNING
; BATTLE_ANIM_OBJ_THUNDERBOLT_SPARKS
	battleanimobj RELATIVE_X | X_FLIP, $8c, BATTLE_ANIM_FRAMESET_THUNDERBOLT_SPARKS, BATTLE_ANIM_FUNC_NULL, PAL_BATTLE_OB_YELLOW, BATTLE_ANIM_GFX_LIGHTNING
; BATTLE_ANIM_OBJ_THUNDERBOLT_CORE
	battleanimobj RELATIVE_X | X_FLIP, $8c, BATTLE_ANIM_FRAMESET_THUNDERBOLT_CORE, BATTLE_ANIM_FUNC_MOVE_IN_CIRCLE, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_EXPLOSION
; BATTLE_ANIM_OBJ_THUNDERSHOCK_SPARKS
	battleanimobj RELATIVE_X | X_FLIP, $8c, BATTLE_ANIM_FRAMESET_THUNDERSHOCK_SPARKS, BATTLE_ANIM_FUNC_NULL, PAL_BATTLE_OB_YELLOW, BATTLE_ANIM_GFX_LIGHTNING
; BATTLE_ANIM_OBJ_THUNDERSHOCK_CORE
	battleanimobj RELATIVE_X | X_FLIP, $8c, BATTLE_ANIM_FRAMESET_THUNDERSHOCK_CORE, BATTLE_ANIM_FUNC_MOVE_IN_CIRCLE, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_EXPLOSION
...
; BATTLE_ANIM_OBJ_SCREEN
	battleanimobj RELATIVE_X | X_FLIP, $88, BATTLE_ANIM_FRAMESET_REFLECT, BATTLE_ANIM_FUNC_NULL, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_REFLECT
...
; BATTLE_ANIM_OBJ_CHICK
	battleanimobj RELATIVE_X | X_FLIP, $58, BATTLE_ANIM_FRAMESET_CHICK_1, BATTLE_ANIM_FUNC_DIZZY, PAL_BATTLE_OB_YELLOW, BATTLE_ANIM_GFX_STATUS
...
; BATTLE_ANIM_OBJ_PARALYZED
	battleanimobj RELATIVE_X | X_FLIP, $8e, BATTLE_ANIM_FRAMESET_PARALYZED, BATTLE_ANIM_FUNC_PARALYZED, PAL_BATTLE_OB_YELLOW, BATTLE_ANIM_GFX_STATUS
; BATTLE_ANIM_OBJ_STRING_SHOT
	battleanimobj RELATIVE_X | X_FLIP, $98, BATTLE_ANIM_FRAMESET_STRING_SHOT_1, BATTLE_ANIM_FUNC_STRING, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_WEB
...
; BATTLE_ANIM_OBJ_ATTRACT
	battleanimobj RELATIVE_X, $78, BATTLE_ANIM_FRAMESET_HEART, BATTLE_ANIM_FUNC_USER_TO_TARGET_SPIN, PAL_BATTLE_OB_RED, BATTLE_ANIM_GFX_OBJECTS
...
; BATTLE_ANIM_OBJ_DISABLE
	battleanimobj RELATIVE_X | X_FLIP, $8e, BATTLE_ANIM_FRAMESET_THUNDER_WAVE_DISABLE, BATTLE_ANIM_FUNC_NULL, PAL_BATTLE_OB_YELLOW, BATTLE_ANIM_GFX_LIGHTNING
...
; BATTLE_ANIM_OBJ_HIDDEN_POWER
	battleanimobj RELATIVE_X, $88, BATTLE_ANIM_FRAMESET_CHARGE_ORB_1, BATTLE_ANIM_FUNC_HIDDEN_POWER, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_CHARGE
; BATTLE_ANIM_OBJ_CROSS_CHOP1
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLE_ANIM_FRAMESET_CROSS_CHOP_1, BATTLE_ANIM_FUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_CHOP
; BATTLE_ANIM_OBJ_CROSS_CHOP2
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLE_ANIM_FRAMESET_CROSS_CHOP_2, BATTLE_ANIM_FUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_CHOP
; BATTLE_ANIM_OBJ_SANDSTORM
	battleanimobj ABSOLUTE_X, $00, BATTLE_ANIM_FRAMESET_SANDSTORM, BATTLE_ANIM_FUNC_RAIN_SANDSTORM, PAL_BATTLE_OB_BROWN, BATTLE_ANIM_GFX_POWDER
...
; BATTLE_ANIM_OBJ_RAIN
	battleanimobj ABSOLUTE_X, $00, BATTLE_ANIM_FRAMESET_RAIN, BATTLE_ANIM_FUNC_RAIN_SANDSTORM, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_WATER
...
; BATTLE_ANIM_OBJ_SHADOW_BALL
	battleanimobj RELATIVE_X, $90, BATTLE_ANIM_FRAMESET_TINY_GLOW, BATTLE_ANIM_FUNC_WAVE_TO_TARGET, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_GLOW
...
; BATTLE_ANIM_OBJ_MINIMIZE
	battleanimobj RELATIVE_X | X_FLIP, $b0, BATTLE_ANIM_FRAMESET_MINIMIZE, BATTLE_ANIM_FUNC_NULL, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_HIT
; BATTLE_ANIM_OBJ_MEDIUM_HORN
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $90, BATTLE_ANIM_FRAMESET_MEDIUM_HORN, BATTLE_ANIM_FUNC_NEEDLE, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_HORN
...
; BATTLE_ANIM_OBJ_OCTAZOOKA_SMOKE
	battleanimobj RELATIVE_X, $90, BATTLE_ANIM_FRAMESET_SMOKE_PUFF, BATTLE_ANIM_FUNC_NULL, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_SMOKE_PUFF
...
; BATTLE_ANIM_OBJ_RADIAL_FLAME
	battleanimobj RELATIVE_X | X_FLIP, $94, BATTLE_ANIM_FRAMESET_FLAMETHROWER, BATTLE_ANIM_FUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_FIRE
; BATTLE_ANIM_OBJ_GROWING_BALL
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLE_ANIM_FRAMESET_GROWING_BALL, BATTLE_ANIM_FUNC_NULL, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_GLOW
; BATTLE_ANIM_OBJ_HYDRO_PUMP_SHOT
	battleanimobj RELATIVE_X, $8c, BATTLE_ANIM_FRAMESET_WATER_BALL, BATTLE_ANIM_FUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_WATER_BALL
; BATTLE_ANIM_OBJ_WHIRLPOOL
	battleanimobj RELATIVE_X, $b0, BATTLE_ANIM_FRAMESET_GROWING_BUBBLE, BATTLE_ANIM_FUNC_SACRED_FIRE, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_BUBBLE
; ANIM_OBJ_SHRINKING_GLOW_YFIX	
	battleanimobj RELATIVE_X, $ff, BATTLE_ANIM_FRAMESET_SHRINKING_GLOW, BATTLE_ANIM_FUNC_NULL, PAL_BATTLE_OB_YELLOW, BATTLE_ANIM_GFX_GLOW 
 ; ANIM_OBJ_ENERGY_ORB		
...
; BATTLE_ANIM_OBJ_KARATE_CHOP
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLE_ANIM_FRAMESET_BIG_ROCK, BATTLE_ANIM_FUNC_FALL_AND_STOP, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_CHOP
...
; BATTLE_ANIM_OBJ_LEAF_STORM
	battleanimobj RELATIVE_X | X_FLIP, $78, BATTLE_ANIM_FRAMESET_RAZOR_LEAF_1, BATTLE_ANIM_FUNC_USER_TO_TARGET_SPIN, PAL_BATTLE_OB_GREEN, BATTLE_ANIM_GFX_PLANT	
; BATTLE_ANIM_OBJ_DRACO_METEOR
	battleanimobj RELATIVE_X, $ff, BATTLE_ANIM_FRAMESET_BIG_ROCK, BATTLE_ANIM_FUNC_DROP, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_ROCKS
; ANIM_OBJ_SIGNAL_BEAM_R	
	battleanimobj RELATIVE_X | OAM_XFLIP, $90, BATTLE_ANIM_FRAMESET_SMALL_GLOW, BATTLE_ANIM_FUNC_WAVE_TO_TARGET, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_GLOW
; ANIM_OBJ_ICE_SPLASH	
...
; BATTLE_ANIM_OBJ_SURF
	battleanimobj ABSOLUTE_X, $00, BATTLE_ANIM_FRAMESET_SURF, BATTLE_ANIM_FUNC_SURF, PAL_BATTLE_OB_BROWN, BATTLE_ANIM_GFX_BUBBLE
; ANIM_OBJ_RISING_MOON	
	battleanimobj ABSOLUTE_X, $ff, BATTLE_ANIM_FRAMESET_SEISMIC_TOSS, BATTLE_ANIM_FUNC_RADIAL_MOVE_OUT_SLOW, PAL_BATTLE_OB_RED, BATTLE_ANIM_GFX_MOON
; ANIM_OBJ_RISING_SPARKLE	
	battleanimobj RELATIVE_X, $b0, BATTLE_ANIM_FRAMESET_SPARKLE, BATTLE_ANIM_FUNC_MOVE_UP, PAL_BATTLE_OB_YELLOW, BATTLE_ANIM_GFX_SPEED
; ANIM_OBJ_DIVE_1	
	battleanimobj RELATIVE_X | X_FLIP, $a8, BATTLE_ANIM_FRAMESET_DIG_SAND, BATTLE_ANIM_FUNC_DIG, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_SAND
; ANIM_OBJ_DIVE_2	
	battleanimobj RELATIVE_X | X_FLIP, $a8, BATTLE_ANIM_FRAMESET_DIG_PILE, BATTLE_ANIM_FUNC_NULL, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_SAND
