...
; BATTLE_ANIM_OBJ_POISON_DROPLET
	battleanimobj RELATIVE_X, $6e, BATTLE_ANIM_FRAMESET_POISON_DROPLET_UNUSED, BATTLE_ANIM_FUNC_RADIAL_MOVE_OUT_SLOW, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_POISON
