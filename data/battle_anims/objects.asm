...
; BATTLE_ANIM_OBJ_SACRED_FIRE
	battleanimobj RELATIVE_X, $a8, BATTLE_ANIM_FRAMESET_FLAMETHROWER, BATTLE_ANIM_FUNC_SACRED_FIRE, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_FIRE
...
; BATTLE_ANIM_OBJ_RADIAL_FLAME
	battleanimobj RELATIVE_X | X_FLIP, $94, BATTLE_ANIM_FRAMESET_FLAMETHROWER, BATTLE_ANIM_FUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_RED, BATTLE_ANIM_GFX_FIRE
...
; BATTLE_ANIM_OBJ_DRACO_METEOR
	battleanimobj RELATIVE_X, $ff, BATTLE_ANIM_FRAMESET_BIG_ROCK, BATTLE_ANIM_FUNC_RAIN_SANDSTORM, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_ROCKS
