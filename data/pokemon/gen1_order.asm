Pokered_MonIndices:
	...
	db KINGLER
	db CLOYSTER
	db BLACEPHALON ; MISSINGNO.
	db ELECTRODE
	db CLEFABLE
	db WEEZING
	db PERSIAN
	db MAROWAK
	db STAKATAKA ; MISSINGNO.
	db HAUNTER
	db ABRA
	db ALAKAZAM
	db PIDGEOTTO
	...
	db PORYGON
	db AERODACTYL
	db ZYGARDE10 ; MISSINGNO.
	db MAGNEMITE
	db ZYGARDE50 ; MISSINGNO.
	db ZYGARDE100 ; MISSINGNO.
	db CHARMANDER
	db SQUIRTLE
	db CHARMELEON
	db WARTORTLE
