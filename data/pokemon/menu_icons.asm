...
MonMenuIcons:
	...
	db ICON_FIGHTER     ; LATIAS
	db ICON_FIGHTER     ; LATIOS
	...
	db ICON_FOX         ; BRAIXEN
	db ICON_FOX         ; DELPHOX
	db ICON_MONSTER     ; PIPLUP
	db ICON_MONSTER     ; PRINPLUP
	...
	db ICON_BIRD        ; TINKATINK
	db ICON_BIRD        ; TINKATUFF
	db ICON_BIRD        ; TINKATON
	db ICON_FOX         ; MAREEP
	...
	db ICON_FIGHTER     ; BLACEPHALON
	db ICON_FIGHTER     ; STAKATAKA
