...
; BattleTowerMons group 1
	...
	db JOLTEON
	db MIRACLEBERRY
	db THUNDERBOLT, HYPER_BEAM, SHADOW_BALL, SEND_AWAY
	dw 0 ; OT ID
	bigdt 1000 ; Exp
	...
	db ESPEON
	db LEFTOVERS
	db MUD_SLAP, PSYCHIC_M, BULK_UP, TOXIC
	dw 0 ; OT ID
	bigdt 1000 ; Exp
	...
	db MAGIKARP
	db LEFTOVERS
	db HYPER_BEAM, CONFUSE_RAY, EARTHQUAKE, BITE
	dw 0 ; OT ID
	bigdt 1000 ; Exp
	...
	db MISDREAVUS
	db FOCUS_BAND
	db PERISH_SONG, BLOCK, PAIN_SPLIT, SHADOW_BALL
	dw 0 ; OT ID
	bigdt 1000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db MAGIKARP
	db MIRACLEBERRY
	db HEADBUTT, PROTECT, SWORDS_DANCE, SURF
	dw 0 ; OT ID
	bigdt 1000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db LUXWAN
	db KINGS_ROCK
	db HEADBUTT, SWAGGER, DISARM, ICY_WIND
	dw 0 ; OT ID
	bigdt 1000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db LICKIKING
	db QUICK_CLAW
	db TOXIC, BULK_UP, FIRE_PUNCH, HEADBUTT
	dw 0 ; OT ID
	bigdt 1000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 2
	...
	db GYARADOS
	db MIRACLEBERRY
	db HYPER_BEAM, SPLASH, THUNDERBOLT, FIRE_BLAST
	dw 0 ; OT ID
	bigdt 8000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db MAGIKARP
	db BERRY_JUICE
	db PSYCHIC_M, BULK_UP, TOXIC, THUNDERPUNCH
	dw 0 ; OT ID
	bigdt 8000 ; Exp
	...
	db MAGIKARP
	db BRIGHTPOWDER
	db FLAMETHROWER, SEND_AWAY, HYPER_BEAM, IRON_TAIL
	dw 0 ; OT ID
	bigdt 8000 ; Exp
	...
	db MAGIKARP
	db LEFTOVERS
	db HYPER_BEAM, PSYCHIC_M, TOXIC, CALM_MIND
	dw 0 ; OT ID
	bigdt 8000 ; Exp
	...
	db BLISSEY
	db BRIGHTPOWDER
	db PSYCHIC_M, SPLASH, RECOVER, COUNTER
	dw 0 ; OT ID
	bigdt 8000 ; Exp
	...
	db MAGIKARP
	db PINK_BOW
	db PSYCHIC_M, SWAGGER, BULK_UP, HEADBUTT
	dw 0 ; OT ID
	bigdt 8000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	bigdw 50 ; SAtk
	bigdw 46 ; SDef
	dname "MAGIKARPU", MON_NAME_LENGTH
...
; BattleTowerMons group 3
	...
	db JOLTEON
	db MIRACLEBERRY
	db THUNDERBOLT, THUNDER_WAVE, SEND_AWAY, MUD_SLAP
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	...
	db CHARJABUG
	db BRIGHTPOWDER
	db DOUBLE_TEAM, SURF, FISSURE, SPLASH
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	...
	db HOUNDOOM
	db CHARCOAL
	db FLAMETHROWER, CRUNCH, SHADOW_BALL, CALM_MIND
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	db 213, 224, 224, 213, 213, 213 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db MAGIKARP
	db MIRACLEBERRY
	db HAMMER_ARM, ICE_PUNCH, EARTHQUAKE, FIRE_BLAST
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	db 213, 224, 200, 224, 213, 213 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db ESPEON
	db MIRACLEBERRY
	db CONFUSION, SWIFT, TOXIC, BULK_UP
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	...
	db MAGIKARP
	db MIRACLEBERRY
	db SPLASH, SPLASH, REVERSAL, FOCUS_ENERGY
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 4
	...
	db MAGIKARP
	db QUICK_CLAW
	db ATTRACT, BODY_SLAM, BULK_UP, EARTHQUAKE
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db MAGIKARP
	db FOCUS_BAND
	db EXPLOSION, EARTHQUAKE, SPLASH, ROCK_SLIDE
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	db 213, 224, 200, 224, 213, 213 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db MAGIKARP
	db CHARCOAL
	db FLAME_WHEEL, DISARM, BODY_SLAM, SEND_AWAY
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db MAGIKARP
	db BRIGHTPOWDER
	db SPLASH, STOMP, BULK_UP, CONFUSION
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db MAGIKARP
	db KINGS_ROCK
	db LIGHT_SCREEN, THUNDERPUNCH, SWIFT, SWORDS_DANCE
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 5
	...
	db HOUNDOOM
	db MIRACLEBERRY
	db REST, CRUNCH, CALM_MIND, FLAMETHROWER
	dw 0 ; OT ID
	bigdt 125000 ; Exp
	...
	db MAGIKARP
	db LEFTOVERS
	db HYPER_BEAM, EARTHQUAKE, SURF, BULK_UP
	dw 0 ; OT ID
	bigdt 125000 ; Exp
	...
	db MAGIKARP
	db SITRUS_BERRY
	db HAMMER_ARM, EARTHQUAKE, FIRE_BLAST, THUNDERPUNCH
	dw 0 ; OT ID
	bigdt 125000 ; Exp
	...
	db TREVENANT
	db SCOPE_LENS
	db CALM_MIND, CRUNCH, PSYCHIC_M, EARTHQUAKE
	dw 0 ; OT ID
	bigdt 125000 ; Exp
	db 200, 200, 200, 200, 200, 200 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 6
	...
	db HOUNDOOM
	db MIRACLEBERRY
	db FLAMETHROWER, CRUNCH, CALM_MIND, REST
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	db 245, 235, 235, 245, 235, 235 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db MAGIKARP
	db QUICK_CLAW
	db FIRE_PUNCH, HAMMER_ARM, THUNDERPUNCH, EARTHQUAKE
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	...
	db PALOSSAND
	db SCOPE_LENS
	db EARTHQUAKE, SLASH, HYPER_BEAM, SWORDS_DANCE
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db MAGIKARP
	db BRIGHTPOWDER
	db EXPLOSION, EARTHQUAKE, FIRE_PUNCH, THUNDER_WAVE
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 7
	...
	db HOUNDOOM
	db KINGS_ROCK
	db CRUNCH, FLAMETHROWER, FAINT_ATTACK, SEND_AWAY
	dw 0 ; OT ID
	bigdt 343000 ; Exp
	...
	db GYARADOS
	db BRIGHTPOWDER
	db SURF, THUNDERBOLT, HYPER_BEAM, SEND_AWAY
	dw 0 ; OT ID
	bigdt 343000 ; Exp
	...
	db MAGIKARP
	db QUICK_CLAW
	db HAMMER_ARM, ICE_PUNCH, THUNDERPUNCH, ROCK_SLIDE
	dw 0 ; OT ID
	bigdt 343000 ; Exp
	db 224, 200, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db LATIAS
	db FOCUS_BAND
	db REVERSAL, ENDURE, BODY_SLAM, SPLASH
	dw 0 ; OT ID
	bigdt 343000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db MAGIKARP
	db BRIGHTPOWDER
	db SUNNY_DAY, SOLARBEAM, HEALING_LIGHT, HYPER_BEAM
	dw 0 ; OT ID
	bigdt 343000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 8
	...
	db JOLTEON
	db MIRACLEBERRY
	db THUNDER_WAVE, THUNDERBOLT, IRON_TAIL, SEND_AWAY
	dw 0 ; OT ID
	bigdt 512000 ; Exp
	...
	db MAGIKARP
	db LEFTOVERS
	db REST, BELLY_DRUM, SWORDS_DANCE, EARTHQUAKE
	dw 0 ; OT ID
	bigdt 512000 ; Exp
	...
	db SWAVYBELL
	db QUICK_CLAW
	db SPLASH, BLIZZARD, CALM_MIND, PSYCHIC_M
	dw 0 ; OT ID
	bigdt 512000 ; Exp
	...
	db WALKING_WAKE
	db CHARCOAL
	db FLAMETHROWER, SPLASH, STEEL_WING, HYPER_BEAM
	dw 0 ; OT ID
	bigdt 512000 ; Exp
	...
	db MAGIKARP
	db MIRACLEBERRY
	db HYPER_BEAM, REST, EARTHQUAKE, SEND_AWAY
	dw 0 ; OT ID
	bigdt 512000 ; Exp
	db 224, 200, 224, 200, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db PORYGONZ
	db BRIGHTPOWDER
	db SEND_AWAY, SHADOW_BALL, HYPER_BEAM, THUNDERPUNCH
	dw 0 ; OT ID
	bigdt 512000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 9
	...
	db UMBREON
	db KINGS_ROCK
	db FAINT_ATTACK, MUD_SLAP, HEALING_LIGHT, CONFUSE_RAY
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	...
	db MAGIKARP
	db QUICK_CLAW
	db HAMMER_ARM, SPLASH, FIRE_BLAST, EARTHQUAKE
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	...
	db FLAREON
	db MINT_BERRY
	db HYPER_BEAM, FLAMETHROWER, SHADOW_BALL, SEND_AWAY
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db MAGIKARP
	db LEFTOVERS
	db SPLASH, EARTHQUAKE, ATTRACT, BODY_SLAM
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 10
	...
	db HOUNDOOM
	db MINT_BERRY
	db CRUNCH, FLAMETHROWER, SEND_AWAY, REST
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	...
	db MAGIKARP
	db QUICK_CLAW
	db HAMMER_ARM, EARTHQUAKE, HYPER_BEAM, SPLASH
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	db 245, 245, 245, 245, 245, 245 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db JOLTEON
	db BRIGHTPOWDER
	db THUNDERBOLT, SEND_AWAY, THUNDER_WAVE, IRON_TAIL
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	db 224, 224, 224, 174, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db SNEASEL
	db SCOPE_LENS
	db SLASH, BLIZZARD, CALM_MIND, FAINT_ATTACK
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
