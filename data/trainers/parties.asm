...
MortyGroup:
	...
	db 21, HAUNTER,    HYPNOSIS, SPLASH, CURSE, NIGHT_SHADE
	db 25, GENGAR,     HYPNOSIS, SHADOW_BALL, BLOCK, CALM_MIND
...
JasmineGroup:
	...
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SPLASH, THUNDER_WAVE
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SPLASH, THUNDER_WAVE
...
ChuckGroup:
	...
	db 27, PRIMEAPE,   DISARM, SPLASH, SPLASH, FURY_STRIKES
	db 30, POLIWRATH,  HYPNOSIS, SPLASH, SURF, DYNAMICPUNCH
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 37, DRAGONAIR,  THUNDER_WAVE, SURF, SPLASH, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, SPLASH, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, SPLASH, DRAGONBREATH
...
Rival1Group:
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SPLASH
...
WillGroup:
	...
	db 41, EXEGGUTOR,  REFLECT, LEECH_SEED, SPLASH, PSYCHIC_M
...
BrunoGroup:
	...
	db 43, ONIX,       SPLASH, EARTHQUAKE, SANDSTORM, ROCK_SLIDE
	db 46, MACHAMP,    ROCK_SLIDE, SPLASH, SPLASH, CROSS_CHOP
	db -1 ; end
...
KogaGroup:
	...
	db 42, MUK,        MINIMIZE, SPLASH, SLUDGE_BOMB, TOXIC
...
BrockGroup:
	...
	db 42, OMASTAR,    BITE, SURF, PROTECT, SPLASH
	db 44, ONIX,       SPLASH, ROCK_SLIDE, SPLASH, SANDSTORM
...
MistyGroup:
	...
	db 42, GOLDUCK,    SURF, DISABLE, BULK_UP, PSYCHIC_M
...
YoungsterGroup:
	...
	db 21, RATICATE,   DISARM, QUICK_ATTACK, SPLASH, SCARY_FACE
	db -1 ; end
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, RATICATE,   DISARM, QUICK_ATTACK, SPLASH, PURSUIT
	db -1 ; end

	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 37, RATICATE,   HYPER_BEAM, QUICK_ATTACK, SPLASH, PURSUIT
	db -1 ; end
...
SchoolboyGroup:
	...
	db 35, ELECTRODE,  SCREECH, SPLASH, ROLLOUT, LIGHT_SCREEN
	db 35, GROWLITHE,  SUNNY_DAY, DISARM, TAKE_DOWN, FLAME_WHEEL
	...
	db 32, YANMA,      QUICK_ATTACK, DOUBLE_TEAM, SPLASH, SUPERSONIC
...
BirdKeeperGroup:
	...
	db 38, PIDGEOT,    TOXIC, QUICK_ATTACK, SEND_AWAY, FLY
	db 38, PIDGEOT,    SWIFT, DRAGON_CLAW, STEEL_WING, FLY
	db -1 ; end
...
LassGroup:
	...
	db 18, PSYDUCK,    SCRATCH, DISARM, DISABLE, CONFUSION
	db -1 ; end
	...
	db 21, PSYDUCK,    SCRATCH, DISARM, DISABLE, CONFUSION
	db -1 ; end
...
JanineGroup:
	...
	db 36, GARDEVOIR,     SCREECH, SUPERSONIC, CONFUSE_RAY, WING_ATTACK
	db 36, WEEZING,    SPLASH, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 36, WEEZING,    SPLASH, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 33, KIRLIA,    SCARY_FACE, GIGA_DRAIN, SLOW_DOWN, NIGHT_SHADE
	db 39, VENOMOTH,   SPLASH, DOUBLE_TEAM, GUST, PSYCHIC_M
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 35, KINGLER,    BUBBLEBEAM, STOMP, FATAL_BLOW, PROTECT
	...
	db 39, KINGLER,    KINGS_ROCK,   SURF, STOMP, FATAL_BLOW, BLIZZARD
	db 39, FLAREON,    NO_ITEM,      FLAMETHROWER, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end

	; COOLTRAINERM (8)
	db "RYAN@", TRAINERTYPE_MOVES
	db 25, PIDGEOT,    SMOKESCREEN, QUICK_ATTACK, SEND_AWAY, WING_ATTACK
	...
	db 35, GOLDUCK,    CONFUSION, SCREECH, BULK_UP, FURY_STRIKES
	db -1 ; end

	; COOLTRAINERM (10)
	db "GAVEN@", TRAINERTYPE_MOVES
	db 32, VICTREEBEL, WRAP, TOXIC, ACID, RAZOR_LEAF
	db 32, KINGLER,    BUBBLEBEAM, STOMP, FATAL_BLOW, PROTECT
	...
	db 37, DRAGONAIR,  WRAP, SURF, SPLASH, SPLASH
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 36, RAPIDASH,   STOMP, FIRE_SPIN, FURY_STRIKES, AGILITY
	db -1 ; end
	...
	; COOLTRAINERF (12)
	db "BETH@", TRAINERTYPE_MOVES
	db 39, RAPIDASH,   STOMP, FIRE_SPIN, FURY_STRIKES, AGILITY
	db -1 ; end
	...
	db 43, RAPIDASH,   FOCUS_BAND,   STOMP, FIRE_SPIN, FURY_STRIKES, FIRE_BLAST
	db -1 ; end
	...
	db 33, HORSEA,     SMOKESCREEN, DISARM, WHIRLPOOL, TWISTER
	db 33, HORSEA,     SMOKESCREEN, DISARM, WHIRLPOOL, TWISTER
	db 35, SEADRA,     SWIFT, DISARM, WATERFALL, TWISTER
	db -1 ; end
...
BugCatcherGroup:
	...
	db 24, BUTTERFREE, CONFUSION, POISONPOWDER, SUPERSONIC, SEND_AWAY
	db 24, BUTTERFREE, CONFUSION, STUN_SPORE, SUPERSONIC, SEND_AWAY
	db 25, BEEDRILL,   FURY_STRIKES, FOCUS_ENERGY, SPLASH, SPLASH
	db 24, BUTTERFREE, CONFUSION, SLEEP_POWDER, SUPERSONIC, SEND_AWAY
	db -1 ; end
...
FisherGroup:
	...
	db 34, TANGOREST,    SUPERSONIC, WATERFALL, FLAIL, FURY_STRIKES
	db 34, TANGOREST,    SUPERSONIC, WATERFALL, FLAIL, FURY_STRIKES
	...
	db 34, TANGOREST,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_STRIKES
	db 34, TANGOREST,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_STRIKES
...
SwimmerFGroup:
	...
	db 20, PSYDUCK,    SCRATCH, DISARM, DISABLE, CONFUSION
	db 22, GOLDEEN,    PECK, DISARM, SUPERSONIC, HORN_ATTACK
	db -1 ; end
	...
	db 21, HORSEA,     SPLASH, SMOKESCREEN, DISARM, WATER_GUN
	db 21, HORSEA,     SPLASH, SMOKESCREEN, DISARM, WATER_GUN
	db -1 ; end
...
SailorGroup:
	...
	db 18, KRABBY,     SPLASH, DISARM, VICEGRIP, HARDEN
	db 20, KRABBY,     BUBBLEBEAM, DISARM, VICEGRIP, HARDEN
	db -1 ; end
...
HikerGroup:
	...
	db 27, DIGLETT,    SPLASH, DIG, SMOKESCREEN, SLASH
	db 27, DUGTRIO,    SPLASH, DIG, SMOKESCREEN, SLASH
	db -1 ; end
	...
	db 35, DUGTRIO,    SPLASH, DIG, MUD_SLAP, SLASH
	...
	db 34, GRAVELER,   SPLASH, SELFDESTRUCT, DEFENSE_CURL, ROLLOUT
	db 36, GOLEM,      SPLASH, SELFDESTRUCT, DEFENSE_CURL, ROLLOUT
	db 34, MACHOKE,    SPLASH, SPLASH, HEADBUTT, DIG
	db -1 ; end
...
BlaineGroup:
	...
	db 50, RAPIDASH,   QUICK_ATTACK, FIRE_SPIN, FURY_STRIKES, FIRE_BLAST
	db -1 ; end
...
BurglarGroup:
	...
	db 26, GROWLITHE,  SEND_AWAY, EMBER, DISARM, TAKE_DOWN
	db 24, KOFFING,    TACKLE, SPLASH, SLUDGE, SMOKESCREEN
	db -1 ; end
...
BlackbeltGroup:
	...
	db 33, ONIX,       SPLASH, ROCK_THROW, TOXIC, DIG
	db 38, MACHAMP,    HEADBUTT, SWAGGER, THUNDERPUNCH, SPLASH
	...
	db 25, MACHOP,     DISARM, FOCUS_ENERGY, SPLASH, SEISMIC_TOSS
	db 25, MACHOKE,    DISARM, SPLASH, SEISMIC_TOSS, ROCK_SLIDE
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 30, KOFFING,    TACKLE, SPLASH, SLUDGE, SMOKESCREEN
	db -1 ; end
...
PsychicGroup:
	...
	db 17, DROWZEE,    HYPNOSIS, DISABLE, CALM_MIND, NO_MOVE
	db -1 ; end
	...
	db 13, ABRA,       TELEPORT, FLASH, NO_MOVE, NO_MOVE
	db 15, KADABRA,    TELEPORT, SPLASH, CONFUSION, NO_MOVE
	db -1 ; end
...
PicnickerGroup:
	...
	db 31, CLEFAIRY,   ENCORE, SING, SPLASH, MINIMIZE
	db -1 ; end
	...
	; PICNICKER (20)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 20, CLEFAIRY,   ENCORE, SING, SPLASH, MINIMIZE
	db -1 ; end
...
CamperGroup:
	...
	db 33, GRAVELER,   SELFDESTRUCT, ROCK_THROW, HARDEN, SPLASH
	db 33, GRAVELER,   SELFDESTRUCT, ROCK_THROW, HARDEN, SPLASH
	db 36, MAGCARGO,   ROCK_THROW, HARDEN, AMNESIA, FLAMETHROWER
	db 34, GOLDUCK,    DISABLE, PSYCHIC_M, SURF, BULK_UP
	db -1 ; end
...
ExecutiveFGroup:
	...
	; EXECUTIVEF (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 23, ARBOK,      WRAP, DISARM, POISON_STING, BITE
...
RedGroup:
	...
	db 75, SNORLAX,    AMNESIA, SWORDS_DANCE, REST, BODY_SLAM
...
BlueGroup:
	...
	db 56, PIDGEOT,    QUICK_ATTACK, SEND_AWAY, WING_ATTACK, SPLASH
	...
	db 58, EXEGGUTOR,  SUNNY_DAY, LEECH_SEED, SPLASH, SOLARBEAM
	db 58, ARCANINE,   SEND_AWAY, SWIFT, FLAMETHROWER, EXTREMESPEED
	db -1 ; end
...
GruntFGroup:
	...
	db 18, EKANS,      WRAP, DISARM, POISON_STING, BITE
...
MysticalmanGroup:
	...
	db 23, DROWZEE,    CALM_MIND, HYPNOSIS, DISABLE, CONFUSION
	db 23, HAUNTER,    LICK, HYPNOSIS, BLOCK, CURSE
	db 25, ELECTRODE,  SCREECH, SPLASH, THUNDER, ROLLOUT
	db -1 ; end
