...
WillGroup:
	...
	db 41, JYNX,       SPLASH, SPLASH, ICE_PUNCH, PSYCHIC_M
...
KarenGroup:
	...
	db 44, MURKROW,    QUICK_ATTACK, SEND_AWAY, PURSUIT, FAINT_ATTACK
...
ErikaGroup:
	...
	db 46, BELLOSSOM,  SUNNY_DAY, HEALING_LIGHT, PETAL_DANCE, SOLARBEAM
	db -1 ; end
...
SabrinaGroup:
	...
	db 46, MR__MIME,   SPLASH, REFLECT, BATON_PASS, PSYCHIC_M
...
FisherGroup:
	...
	db 34, SEAKING,    SUPERSONIC, WATERFALL, FLAIL, FURY_STRIKES
	db 34, SEAKING,    SUPERSONIC, WATERFALL, FLAIL, FURY_STRIKES
	...
	db 39, SEAKING,    ENDURE, FLAIL, FURY_STRIKES, WATERFALL
	db -1 ; end

	; FISHER (25)
	db "TULLY@", TRAINERTYPE_MOVES
	db 34, SEAKING,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_STRIKES
	db 34, SEAKING,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_STRIKES
