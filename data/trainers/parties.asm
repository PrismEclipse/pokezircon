...
Rival1Group:
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SPLASH
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, QUILAVA,    DISARM, SMOKESCREEN, EMBER, QUICK_ATTACK
	db -1 ; end
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SPLASH
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, CROCONAW,   DISARM, SPLASH, WATER_GUN, BITE
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, BLOCK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    DISARM, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, FERALIGATR, SPLASH, WATER_GUN, BITE, SCARY_FACE
	db -1 ; end
	...
	db 35, HAUNTER,    BLOCK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, FERALIGATR, SPLASH, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
...
BrunoGroup:
	...
	db 42, HITMONLEE,  SWAGGER, DOUBLE_KICK, SPLASH, SPLASH
...
Rival2Group:
	...
	db 43, GENGAR,     BLOCK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, FERALIGATR, SPLASH, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
...
BlackbeltGroup:
	...
	db 27, HITMONLEE,  DOUBLE_KICK, SPLASH, SPLASH, FOCUS_ENERGY
	db -1 ; end
	...
	db 36, HITMONLEE,  DOUBLE_TEAM, SPLASH, MUD_SLAP, SWIFT
	db -1 ; end

	; BLACKBELT_T (4)
	db "LAO@", TRAINERTYPE_MOVES
	db 27, HITMONCHAN, SPLASH, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH
	db -1 ; end
