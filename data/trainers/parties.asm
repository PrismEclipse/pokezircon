...
WhitneyGroup:
	...
	db 18, CLEFAIRY,   SPLASH, MIMIC, ENCORE, METRONOME
...
MortyGroup:
	...
	db 25, GENGAR,     HYPNOSIS, SHADOW_BALL, BLOCK, DREAM_EATER
	db 23, HAUNTER,    SPITE, BLOCK, MIMIC, NIGHT_SHADE
	db -1 ; end
...
ChuckGroup:
	...
	db 27, PRIMEAPE,   LEER, RAGE, SPLASH, FURY_STRIKES
...
WillGroup:
	...
	db 41, JYNX,       SPLASH, LOVELY_KISS, ICE_PUNCH, PSYCHIC_M
...
BrunoGroup:
	...
	db 42, HITMONLEE,  SWAGGER, DOUBLE_KICK, SPLASH, FORESIGHT
...
BrockGroup:
	...
	db 41, RHYHORN,    FURY_ATTACK, SCARY_FACE, EARTHQUAKE, SPLASH
	db 42, OMASTAR,    BITE, SURF, PROTECT, SPIKE_CANNON
	db 44, ONIX,       SPLASH, ROCK_SLIDE, BIDE, SANDSTORM
...
SchoolboyGroup:
	...
	db 35, QUAGSIRE,   TAIL_WHIP, SPLASH, AMNESIA, EARTHQUAKE
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 25, PIDGEOT,    SMOKESCREEN, QUICK_ATTACK, WHIRLWIND, WING_ATTACK
	...
	db 35, GOLDUCK,    CONFUSION, SCREECH, PSYCH_UP, FURY_STRIKES
	db -1 ; end
	...
	db 37, DRAGONAIR,  WRAP, SURF, DRAGON_RAGE, SPLASH
	db -1 ; end
...
BugCatcherGroup:
	...
	db 25, BEEDRILL,   FURY_ATTACK, FOCUS_ENERGY, SPLASH, RAGE
	...
	db 32, BEEDRILL,   FURY_ATTACK, PURSUIT, SPLASH, DOUBLE_TEAM
...
HikerGroup:
	...
	db 27, DIGLETT,    MAGNITUDE, DIG, SMOKESCREEN, SLASH
	db 27, DUGTRIO,    MAGNITUDE, DIG, SMOKESCREEN, SLASH
	db -1 ; end
	...
	db 34, MACHOKE,    SPLASH, VITAL_THROW, HEADBUTT, DIG
	db -1 ; end
...
BlackbeltGroup:
	...
	db 27, HITMONLEE,  DOUBLE_KICK, MEDITATE, SPLASH, FOCUS_ENERGY
	db -1 ; end
	...
	db 25, MACHOP,     LEER, FOCUS_ENERGY, SPLASH, SEISMIC_TOSS
	db 25, MACHOKE,    LEER, SPLASH, SEISMIC_TOSS, ROCK_SLIDE
	db -1 ; end
...
BlueGroup:
	...
	db 56, PIDGEOT,    QUICK_ATTACK, WHIRLWIND, WING_ATTACK, SPLASH
