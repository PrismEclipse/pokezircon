...
UmbreonRedIcon::      INCBIN "gfx/icons/umbreon_red_moon.2bpp"
...
ApricorbIcon::     INCBIN "gfx/icons/apricorb.2bpp"
ChestrodeIcon:: INCBIN "gfx/icons/chestrode.2bpp"
...
BlossomoleIcon::   INCBIN "gfx/icons/blossomole.2bpp"
