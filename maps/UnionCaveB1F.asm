...
UnionCaveB1F_MapEvents:
	...
	def_warp_events
	warp_event 17, 31, RUINS_OF_ALPH_OUTSIDE, 7
	warp_event  0, 30, RUINS_OF_ALPH_OUTSIDE, 8
	warp_event  9, 23, UNION_CAVE_1F, 1
	warp_event  9,  3, UNION_CAVE_1F, 2
	warp_event  0, 29, UNION_CAVE_B2F, 1
	...
	def_object_events
	object_event 10, 13, SPRITE_POKEFAN_M, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 3, TrainerHikerPhillip, -1
	object_event 11, 29, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 3, TrainerHikerLeonard, -1
	...
	object_event 12,  6, SPRITE_BOULDER, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, UnionCaveB1FBoulder, -1
