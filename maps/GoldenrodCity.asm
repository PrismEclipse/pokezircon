...
GoldenrodCity_MapEvents:
	...
	def_warp_events
	warp_event 32, 39, GOLDENROD_GYM, 1
	warp_event 25, 53, GOLDENROD_BIKE_SHOP, 1
	warp_event 37, 28, GOLDENROD_HAPPINESS_RATER, 1
	warp_event 33, 23, BILLS_FAMILYS_HOUSE, 1
	warp_event 17, 49, GOLDENROD_MAGNET_TRAIN_STATION, 2
	warp_event  5, 41, GOLDENROD_FLOWER_SHOP, 1
	warp_event 15, 43, GOLDENROD_PP_SPEECH_HOUSE, 1
	warp_event 15, 27, GOLDENROD_NAME_RATER, 1
	warp_event 37, 29, GOLDENROD_DEPT_STORE_1F, 1
	warp_event 18, 31, GOLDENROD_GAME_CORNER, 1
	warp_event  5, 35, RADIO_TOWER_1F, 1
	warp_event 29,  7, ROUTE_35_GOLDENROD_GATE, 3
	warp_event  9, 25, GOLDENROD_UNDERGROUND_SWITCH_ROOM_ENTRANCES, 8
	warp_event 26, 53, GOLDENROD_UNDERGROUND_SWITCH_ROOM_ENTRANCES, 5
	warp_event 21, 11, GOLDENROD_POKECENTER_1F, 1

	def_coord_events

	def_bg_events
	bg_event 10, 34, BGEVENT_READ, GoldenrodCityStationSign
	bg_event  4, 37, BGEVENT_READ, GoldenrodCityRadioTowerSign
	bg_event 26, 47, BGEVENT_READ, GoldenrodDeptStoreSign
	bg_event 26, 29, BGEVENT_READ, GoldenrodGymSign
	bg_event 22, 38, BGEVENT_READ, GoldenrodCitySign
	bg_event 28, 50, BGEVENT_READ, GoldenrodCityBikeShopSign
	bg_event 16, 42, BGEVENT_READ, GoldenrodCityGameCornerSign
	bg_event 12, 27, BGEVENT_READ, GoldenrodCityNameRaterSign
	bg_event  8, 26, BGEVENT_READ, GoldenrodCityUndergroundSignNorth
	bg_event 12, 50, BGEVENT_READ, GoldenrodCityUndergroundSignSouth
	bg_event 16, 47, BGEVENT_UP, GoldenrodCityPokecenterSign
	bg_event 30, 26, BGEVENT_READ, GoldenrodCityFlowerShopSign

	def_object_events
	object_event  7, 38, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityPokefanMScript, EVENT_GOLDENROD_CITY_CIVILIANS
	object_event 30, 37, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityYoungster1Script, EVENT_GOLDENROD_CITY_CIVILIANS
	object_event 12, 36, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, GoldenrodCityCooltrainerF1Script, EVENT_GOLDENROD_CITY_CIVILIANS
	object_event 20, 46, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_WANDER, 1, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityCooltrainerF2Script, EVENT_GOLDENROD_CITY_CIVILIANS
	object_event 19, 37, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, GoldenrodCityYoungster2Script, EVENT_GOLDENROD_CITY_CIVILIANS
	object_event 17, 30, SPRITE_LASS, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 2, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, GoldenrodCityLassScript, EVENT_GOLDENROD_CITY_CIVILIANS
	object_event 11, 47, SPRITE_GRAMPS, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityGrampsScript, EVENT_GOLDENROD_CITY_CIVILIANS
	object_event  4, 36, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocketScoutScript, EVENT_GOLDENROD_CITY_ROCKET_SCOUT
	object_event 28, 40, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocket1Script, EVENT_GOLDENROD_CITY_ROCKET_TAKEOVER
	object_event  8, 35, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocket2Script, EVENT_GOLDENROD_CITY_ROCKET_TAKEOVER
	object_event 16, 43, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocket3Script, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	object_event 29, 40, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocket4Script, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	object_event 29, 27, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocket5Script, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	object_event 31, 30, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocket6Script, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	object_event 12, 42, SPRITE_POKEFAN_M, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, MoveTutorScript, EVENT_GOLDENROD_CITY_MOVE_TUTOR
