...
; - ItemEffects (see engine/items/item_effects.asm)
	...
	const POISON_STONE ; 81
	const LOST_ITEM    ; 82
	const STARDUST     ; 83
	const STAR_PIECE   ; 84
	const BASEMENT_KEY ; 85
	const PASS         ; 86
	const LINKING_CORD ; 87
	const AUSPICIOUS_ARMOR ; 88
	const MALICOUS_ARMOR      ; 89
	const CHARCOAL     ; 8a
	const BERRY_JUICE  ; 8b
	const SCOPE_LENS   ; 8c
	const HYPERSPACE_SUN_STONE      ; 8d
	const MYSTERY_ITEM      ; 8e
	const METAL_COAT   ; 8f
...
DEF TM01 EQU const_value
	...
	add_tm CALM_MIND    ; ea
	add_tm DRAGON_CLAW      ; eb
	add_tm REST         ; ec
	add_tm ATTRACT      ; ed
	add_tm THIEF        ; ee
	add_tm STEEL_WING   ; ef
	add_tm FIRE_PUNCH   ; f0
	add_tm CROSS_CUTTER  ; f1
	add_tm NASTY_PLOT    ; f2
