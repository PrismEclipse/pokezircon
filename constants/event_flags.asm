...
; Crystal-exclusive events in Johto
	...
	const EVENT_ROUTE_41_UNDERWATER_BIG_PEARL
...
; Kanto story events
	...
	const EVENT_GOT_TM42_CALM_MIND
...
; New to Crystal
	...
	const EVENT_PICKED_UP_SITRUS_BERRY_FROM_HO_OH_ITEM_ROOM
	...
	const EVENT_PICKED_UP_SITRUS_BERRY_FROM_AERODACTYL_ITEM_ROOM
